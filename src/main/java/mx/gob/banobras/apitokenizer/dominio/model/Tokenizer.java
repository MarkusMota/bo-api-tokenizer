		...
		try {
			...
			if (tokenizerResponseDTO== null){
				...
				ErrorMessageDTO message = new ErrorMessageDTO(HttpStatus.FORBIDDEN.value(), date,
						ConstantsToken.MSG_TOKEN_NULO.getName());
				tokenizerResponseDTO = new TokenizerResponseDTO();
				tokenizerResponseDTO.setStatusCode(HttpStatus.FORBIDDEN.value());
				tokenizerResponseDTO.setErrorMessageDTO(message);
			}
			...
			ErrorMessageDTO message = new ErrorMessageDTO(HttpStatus.UNAUTHORIZED.value(), new Date(), ConstantsToken.MSG_TOKEN_EXPIRED.getName());
			tokenizerResponseDTO = new TokenizerResponseDTO();
			...
			ErrorMessageDTO message = new ErrorMessageDTO(HttpStatus.FORBIDDEN.value(), new Date(), ConstantsToken.MSG_TOKEN_NULO.getName());
			tokenizerResponseDTO = new TokenizerResponseDTO();
			tokenizerResponseDTO.setStatusCode(HttpStatus.FORBIDDEN.value());
			tokenizerResponseDTO.setErrorMessageDTO(message);
